...
export const OrderDetailProdukSchema = z.object({
  id: z.number(),
  nama: z.string(),
  gambar: z.string(),
  image_url: z.string(),
...
export type OrderDetailProdukResponse = z.infer<typeof OrderDetailProdukSchema>

export const validateOrderDetailProdukResponse = (payload: unknown): OrderDetailProdukResponse =>
  OrderDetailProdukSchema.parse(payload)

export const OrderDetailResourceSchema = z.object({
  id: z.number(),
  produk_item_id: z.number(),
  produk: OrderDetailProdukSchema,
  qty: z.number(),
  harga: z.number(),
  subtotal: z.number(),
})
...
export const OrderResourceSchema = z.object({
  ...
  promotion: OrderPromotionSchema,
...
export type PaymentPromotionResponse = z.infer<typeof PaymentPromotionSchema>

export const validatePaymentPromotionResponse = (payload: unknown): PaymentPromotionResponse =>
  PaymentPromotionSchema.parse(payload)
...
export const PaymentResourceSchema = z.object({
  ...
  items: z.array(OrderDetailResourceSchema),
  promotion: PaymentPromotionSchema,
...
export const ProdukReviewsSummarySchema = z.object({
  avg_rating: z.number(),
  total_review: z.number(),
})

export type ProdukReviewsSummaryResponse = z.infer<typeof ProdukReviewsSummarySchema>

export const validateProdukReviewsSummaryResponse = (payload: unknown): ProdukReviewsSummaryResponse =>
  ProdukReviewsSummarySchema.parse(payload)

export const ProdukReviewsSchema = z.object({
  summary: ProdukReviewsSummarySchema,
...
export const OrderDetailProduksResponseSchema = z.object({
  data: z.array(OrderDetailProdukSchema)
})

export const validateOrderDetailProdukCollectionResponse = (payload: unknown) =>
  OrderDetailProduksResponseSchema.parse(payload)
...
export const PaymentPromotionsResponseSchema = z.object({
  data: z.array(PaymentPromotionSchema)
})

export const validatePaymentPromotionCollectionResponse = (payload: unknown) =>
  PaymentPromotionsResponseSchema.parse(payload)
...
export const ProdukReviewsSummarysResponseSchema = z.object({
  data: z.array(ProdukReviewsSummarySchema)
})

export const validateProdukReviewsSummaryCollectionResponse = (payload: unknown) =>
  ProdukReviewsSummarysResponseSchema.parse(payload)
...
export const RegisterCreatePayload = z.object({
  name: z.string(),
  email: z.string(),
  password: z.string(),
})

export type RegisterCreatePayloadType = z.infer<typeof RegisterCreatePayload>

export const LoginCreatePayload = z.object({
  email: z.string(),
  password: z.string(),
})

export type LoginCreatePayloadType = z.infer<typeof LoginCreatePayload>

export const OauthCustomPayload = z.object({
  redirect_to: z.string().nullable().optional(),
})

export type OauthCustomPayloadType = z.infer<typeof OauthCustomPayload>

export const SocialCreatePayload = z.object({
  provider: z.string(),
...
export type SocialCreatePayloadType = z.infer<typeof SocialCreatePayload>

export const ForgotPasswordCreatePayload = z.object({
  email: z.string(),
})

export type ForgotPasswordCreatePayloadType = z.infer<typeof ForgotPasswordCreatePayload>

export const ResetPasswordCreatePayload = z.object({
  email: z.string(),
  token: z.string(),
  password: z.string(),
})

export type ResetPasswordCreatePayloadType = z.infer<typeof ResetPasswordCreatePayload>
...
export type ProfileUpdatePayloadType = z.infer<typeof ProfileUpdatePayload>

export const CartCreatePayload = z.object({
  produk_item_id: z.string(),
  qty: z.number(),
  code: z.string(),
})

export type CartCreatePayloadType = z.infer<typeof CartCreatePayload>

export const CheckoutCreatePayload = z.object({
  items: z.unknown().optional(),
  items.*.produk_item_id: z.string().optional(),
...
export type CheckoutCreatePayloadType = z.infer<typeof CheckoutCreatePayload>

export const BuyNowCreatePayload = z.object({
  produk_item_id: z.string(),
  qty: z.number(),
  shipping_nama: z.string().nullable().optional(),
  shipping_telepon: z.string().nullable().optional(),
...
export type BuyNowCreatePayloadType = z.infer<typeof BuyNowCreatePayload>

export const WishlistCreatePayload = z.object({
  produk_item_id: z.string(),
})

export type WishlistCreatePayloadType = z.infer<typeof WishlistCreatePayload>
...
export const PaymentCreatePayload = z.object({
  metode: z.string(),
  detail: z.unknown().nullable().optional(),
  provider: z.string().nullable().optional(),
  provider_txn_id: z.string().nullable().optional(),
  idempotency_key: z.string().nullable().optional(),
  gateway_code: z.string().nullable().optional(),
  gateway_message: z.string().nullable().optional(),
})

export type PaymentCreatePayloadType = z.infer<typeof PaymentCreatePayload>

export const AdminCreatePayload = z.object({
  nama: z.string(),
  ...
  jumlah_review: z.number().nullable().optional(),
})

export type AdminCreatePayloadType = z.infer<typeof AdminCreatePayload>
