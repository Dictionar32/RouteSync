...
const completeModelValueProducerEvidence=highLevelProductionFlowEvidence.filter(x=>
...
const out=abs('data-loss-trace-v52.json');fs.writeFileSync(out,JSON.stringify(report,null,2));
