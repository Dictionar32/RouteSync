import type { ClassName, ControllerName, FunctionName, MethodName, ModelName, PropertyName, RelationName, ResourceName, VariableName } from './names';
...
export type BinaryOperator = { readonly kind: 'concat' } | { readonly kind: 'add' } | { readonly kind: 'subtract' } | { readonly kind: 'multiply' } | { readonly kind: 'divide' } | { readonly kind: 'modulo' } | ComparisonOperator | { readonly kind: 'and' } | { readonly kind: 'or' };
...
export type ArrayEntry = { readonly kind: 'implicit'; readonly index: NumberValue; readonly value: Expression; readonly source: SourceSpan } | { readonly kind: 'keyed'; readonly key: Expression; readonly value: Expression; readonly source: SourceSpan };
export type Expression =
  ...
  | { readonly kind: 'method'; readonly receiver: Expression; readonly operation: MethodOperation; readonly arguments: Expressions; readonly path: PropertyPath; readonly source: SourceSpan }
  ...
  | { readonly kind: 'builtin'; readonly function: BuiltinFunction; readonly arguments: Expressions; readonly source: SourceSpan } | { readonly kind: 'call'; readonly function: FunctionName; readonly arguments: Expressions; readonly source: SourceSpan }
  ...
  | { readonly kind: 'nullsafe_method'; readonly receiver: Expression; readonly operation: MethodOperation; readonly arguments: Expressions; readonly path: PropertyPath; readonly source: SourceSpan } | { readonly kind: 'index'; readonly receiver: Expression; readonly key: Expression; readonly source: SourceSpan }
  | { readonly kind: 'array'; readonly entries: readonly ArrayEntry[]; readonly source: SourceSpan } | { readonly kind: 'object'; readonly properties: ObjectProperties; readonly source: SourceSpan } | { readonly kind: 'match'; readonly subject: Expression; readonly arms: MatchArms; readonly source: SourceSpan }
  | { readonly kind: 'model_reference'; readonly model: ModelName; readonly cardinality: ReferenceCardinality; readonly source: SourceSpan } | { readonly kind: 'resource_reference'; readonly resource: ResourceName; readonly cardinality: ReferenceCardinality; readonly source: SourceSpan }
  | { readonly kind: 'closure'; readonly value: Closure; readonly source: SourceSpan } | { readonly kind: 'arrow_function'; readonly parameters: VariableNames; readonly body: Expression; readonly source: SourceSpan } | { readonly kind: 'class_reference'; readonly className: ClassName; readonly source: SourceSpan } | { readonly kind: 'construct'; readonly className: ClassName; readonly arguments: Expressions; readonly source: SourceSpan }
...
export type Closure = { readonly kind: 'closure'; readonly parameters: VariableNames; readonly captures: ClosureCaptures; readonly body: ClosureBody; readonly source: SourceSpan };
export type ClosureBody = { readonly kind: 'expression_body'; readonly expression: Expression } | { readonly kind: 'statement_body'; readonly statements: readonly ClosureStatement[] };
...
export type ClosureForClause =
  ...
  | { readonly kind: 'assignment'; readonly target: AssignmentTarget; readonly value: Expression };
export type ClosureCatchClause = { readonly exceptionType: ClassName; readonly variable: VariableName; readonly body: readonly ClosureStatement[] };
export type ClosureIfAlternative =
  | { readonly kind: 'none' }
  | { readonly kind: 'else_block'; readonly block: readonly ClosureStatement[] }
  | { readonly kind: 'else_if'; readonly statement: Extract<ClosureStatement, { readonly kind: 'if' }> };
export type ClosureFinallyClause = { readonly kind: 'absent' } | { readonly kind: 'present'; readonly block: readonly ClosureStatement[] };
export type ClosureStatement =
  ...
  | { readonly kind: 'assignment'; readonly target: AssignmentTarget; readonly value: Expression }
  | { readonly kind: 'if'; readonly condition: Expression; readonly thenBlock: readonly ClosureStatement[]; readonly alternative: ClosureIfAlternative }
  | { readonly kind: 'foreach'; readonly iterable: Expression; readonly target: ClosureForeachTarget; readonly body: readonly ClosureStatement[] }
  | { readonly kind: 'for'; readonly initializer: ClosureForClause; readonly condition: ClosureForClause; readonly update: ClosureForClause; readonly body: readonly ClosureStatement[] }
  | { readonly kind: 'try'; readonly body: readonly ClosureStatement[]; readonly catches: readonly ClosureCatchClause[]; readonly finallyBlock: ClosureFinallyClause }
