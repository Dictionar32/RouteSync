...
import type { ControllerStatement, CatchHandler } from './controller';
...
export type CatchHandlers = { readonly kind: 'catch_handlers'; readonly items: Sequence<CatchHandler> };
...
export type ControllerStatements = { readonly kind: 'controller_statements'; readonly items: Sequence<ControllerStatement> };
