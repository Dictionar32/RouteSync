...
export class PhpAstFactory {
    ...
    static assignment(target: import('./phpAstTypes').PhpAssignmentTarget, value: PhpAstValue, source: import('./phpAstTypes').TokenDescriptor): PhpStatement { return Object.freeze({ kind: 'assignment', target, value, source }); }
