...
export class ZodToTSEmitIR {
  ...
  private static getTsType(ast: ZodAST): string {
      switch (ast.kind) {
          ...
          case 'zod_object': return 'Record<string, any>'; // Nested objects can be improved later
          default: return 'any';
      }
  }
