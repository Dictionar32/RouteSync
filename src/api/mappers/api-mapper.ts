...
export const toApiOauthRedirectGet = (form: OauthRedirectForm['Get']): OauthRedirectGetPayload => ({
...
export const toApiProdukReviewsCreate = (form: ProdukReviewsForm['Create']): ProdukReviewsCreatePayload => ({
...
export const toApiCartPromoCreate = (form: CartPromoForm['Create']): CartPromoCreatePayload => ({
