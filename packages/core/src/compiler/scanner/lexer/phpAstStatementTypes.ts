...
export type PhpStatement =
    ...
    | { readonly kind: 'return_void'; readonly source: TokenDescriptor } | { readonly kind: 'assignment'; readonly target: PhpAssignmentTarget; readonly value: PhpAstValue; readonly source: TokenDescriptor }
