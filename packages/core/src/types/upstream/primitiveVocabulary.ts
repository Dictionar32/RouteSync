...
import type { ExpressionArguments, MethodOperation, StaticMethodAction, StaticReceiver } from './expression';
import type { SemanticValues } from './collections';
...
export type SemanticCall =
  | { readonly kind: 'method_call'; readonly receiver: SemanticValue; readonly operation: MethodOperation; readonly arguments: ExpressionArguments; readonly result: SemanticValue }
  | { readonly kind: 'static_call'; readonly receiver: StaticReceiver; readonly action: StaticMethodAction; readonly arguments: ExpressionArguments; readonly result: SemanticValue }
  | { readonly kind: 'function_call'; readonly function: FunctionName; readonly arguments: ExpressionArguments; readonly result: SemanticValue };
